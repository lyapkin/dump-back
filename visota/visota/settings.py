...
CKEDITOR_5_CONFIGS = {
    ...
    "extends2": {
        ...
        # "htmlSupport": {"allow": [{"name": "/^(p|h[1-3])$/", "attributes": True}]},
...
LOGGING = {
    ...
    "handlers": {
        "forms.file": {
            ...
            "filename": os.path.join(PROJECT_LOGGING_DIR, "forms.log"),
            "formatter": "simple",
        },
    },
    "loggers": {"visota.forms": {"handlers": ["forms.file"], "level": "INFO", "propogate": False}},
}
